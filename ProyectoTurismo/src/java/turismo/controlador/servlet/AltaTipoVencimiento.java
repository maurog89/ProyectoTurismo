 ...
 */
public class AltaTipoVencimiento extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try  {
            ...
            ImprimirHTML.imprimirEtiquetasIniciales(out,"Alta de Tipo de Vencimientos");
            String[] parametros = new String[]{"tipoVencimiento"};
            String[] obligatorios =  new String[]{"tipoVencimiento"};
            ...
            if(ValidadorDeParametros.validar(validadorVacio,validadorNumerico)){
                ...
                ValidadorDeParametros.insertar("TipoVencimiento", parametros , posicionNumericos, tablasSecundarias, secundarios, request, out);
            }else{
