 ...
 */
public class AltaMedioTransporte extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try  {
            ...
            ImprimirHTML.imprimirEtiquetasIniciales(out,"Alta de Lugares de Medios de Transporte");
            String[] parametros = new String[]{"estadoMedioTransporte","EmpresaTransporte","medioTransporte","descripcionMedioTransporte"};
            String[] obligatorios =  new String[]{"estadoMedioTransporte","EmpresaTransporte","medioTransporte"};
            String[] numericos = new String[]{"estadoMedioTransporte","EmpresaTransporte"};
            ...
            if(ValidadorDeParametros.validar(validadorVacio,validadorNumerico)){
                ...
                ValidadorDeParametros.insertar("MedioTransporte", parametros , posicionNumericos, tablasSecundarias, secundarios, request, out);
            }else{
