...
public class AltaTemporada extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String nombre = request.getParameter("nombreTemporada");
        String descripcion = request.getParameter("descripcionTemporada");
        try {
            ...
            if(nombre.isEmpty())
                ...
                if(descripcion.isEmpty()){
                    new Temporada(nombre,descripcion,"Minimo");
                    out.println("Temporada sin descripcion cargada.");
                }else{                    
                    new Temporada(nombre,descripcion,"Completa");
                    out.println("Temporada cargada.");
                }
            }
