 ...
 */
public class AltaMapa extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try  {
            ...
            ImprimirHTML.imprimirEtiquetasIniciales(out,"Alta de Mapas");
            String[] parametros = new String[]{"Observaciones","longitudMapa","latitudMapa"};
            String[] obligatorios =  new String[]{"longitudMapa","latitudMapa"};
            ...
            if(ValidadorDeParametros.validar(validadorVacio,validadorNumerico)){
                ...
                int[] secundarios = new int[]{0};
                ValidadorDeParametros.insertar("Mapa", parametros , posicionNumericos, tablasSecundarias, secundarios, request, out);
            }else{
