 ...
 */
public class AltaTipoFactura extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try  {
            ...
            ImprimirHTML.imprimirEtiquetasIniciales(out,"Alta de Tipo de Factura");
            String[] parametros = new String[]{"tipoFactura"};
            String[] obligatorios =  new String[]{"tipoFactura"};
            ...
            if(ValidadorDeParametros.validar(validadorVacio,validadorNumerico)){
                ...
                ValidadorDeParametros.insertar("TipoFactura", parametros , posicionNumericos, tablasSecundarias, secundarios, request, out);
            }else{
